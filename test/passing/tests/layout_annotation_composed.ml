val foo :
  ...
  kind4 & _ & (kind_of_ type2 mod mode4))
  mod mode5
  ) 'cmp.
     (module S
...
type ttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt :
  (kind1 & (kind2
            ...
            with type1 & (kiiiiiiiiiiiiiiiiiiiind3 & kiiiiiiiiiiiiiiiiiiiind4)) &
