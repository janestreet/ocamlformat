...
%inline labeled_tuple_pat_element(self):
  ...
  | TILDE LPAREN label = LIDENT COLON cty = core_type RPAREN %prec COMMA
      { let loc = $loc(label) in
        ...
        Some label, mkpat ~loc (Ppat_constraint (pat, cty)) }
