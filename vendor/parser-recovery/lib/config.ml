...
let bindir = "/home/aspectorzabusky/repos/ocaml-jst/installed/bin"

let standard_library_default = "/home/aspectorzabusky/repos/ocaml-jst/installed/lib/ocaml"
...
let ccomp_type = "cc"
let c_compiler = "gcc -std=gnu11"
let c_output_obj = "-o "
let c_has_debug_prefix_map = true
let as_has_debug_prefix_map = true
let ocamlc_cflags = "-std=gnu99 -O2 -fno-strict-aliasing -fwrapv -fno-builtin-memcmp -pthread -fPIC "
...
let ocamlopt_cflags = "-std=gnu99 -O2 -fno-strict-aliasing -fwrapv -fno-builtin-memcmp -pthread -fPIC "
...
let mkdll, mkexe, mkmaindll =
  ...
  if Sys.win32 || Sys.cygwin && supports_shared_libraries then
    try
      ...
      flexlink ^ " -maindll"
    with Not_found ->
      "gcc -std=gnu11 -shared ", "gcc -std=gnu11 -std=gnu99 -O2 -fno-strict-aliasing -fwrapv -fno-builtin-memcmp -pthread -Wall -Wdeclaration-after-statement -fexcess-precision=standard -fno-tree-vrp -ffunction-sections  -Wl,-E ", "gcc -std=gnu11 -shared "
  else
    "gcc -std=gnu11 -shared ", "gcc -std=gnu11 -std=gnu99 -O2 -fno-strict-aliasing -fwrapv -fno-builtin-memcmp -pthread -Wall -Wdeclaration-after-statement -fexcess-precision=standard -fno-tree-vrp -ffunction-sections  -Wl,-E ", "gcc -std=gnu11 -shared "
